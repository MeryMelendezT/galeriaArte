                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <!--<input type="text" class="form-control">-->
                          <html:text property="lugarOrigen" styleClass="form-control" />
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <html:text property="lugarDestino" styleClass="form-control" />
                        </div>
                      </div>
                      <div class="col-md-12">
                        <html:submit styleClass="btn btn-danger pull-right" value="Registrar" />
                      </div>
                    </div>
                  </html:form>
                </div>
                                  ...
                                  <tbody>
                                    <logic:iterate id="tabla" indexId="index" name="listados" property="tabla">
                                      <tr>
                                        ...
                                        <td><bean:write name="tabla" property="lugarOrigen" /></td>
                                        <td><bean:write name="tabla" property="lugarDestino" /></td>
