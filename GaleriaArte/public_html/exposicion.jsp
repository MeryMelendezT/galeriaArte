        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <html:form action="/altasExposicion">
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <!--<input type="text" class="form-control">-->
                          <html:text property="salon_id" styleClass="form-control" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <!--<input type="text" class="form-control">-->
                          <html:text property="fechaInaguracion" styleClass="form-control" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <!--<input type="text" class="form-control">-->
                          <html:text property="fechaClausura" styleClass="form-control" />
                        </div>
                      </div>
                      <div class="col-md-12">
                                  ...
                                  <tbody>
                                    <logic:iterate id="tabla" indexId="index" name="listados" property="tabla">
                                      <tr>
                                        ...
                                        <td><bean:write name="tabla" property="fechaInaguracion" /></td>
                                        <td><bean:write name="tabla" property="fechaClausura" /></td>
