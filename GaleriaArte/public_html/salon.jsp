                                            ...
                                            <div class="col-md-12">
                                              ...
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                  ...
                                                  <!--<input type="email" class="form-control">-->
                                                  <html:text property="capacidad" styleClass="form-control" />
                                                </div>
                                              </div>
                                            </div>
                                            <div class="row" align="center">
                                              <!--<div class="col-md-12">-->
                                                <html:submit styleClass="btn btn-warning pull-right" value="Registrar" />
                                              <!--</div>-->
                                            </div>
                                  ...
                                  <tbody>
                                    <logic:iterate id="tabla" indexId="index" name="listados" property="tabla">
                                      <tr>
                                        ...
                                        <td><bean:write name="tabla" property="capacidad" /></td>
